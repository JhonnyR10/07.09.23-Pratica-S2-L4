...
function epify(stringa) {
  if (stringa.indexOf("EPICODE", 0) === 0) {
    return stringa;
  } else {
    return "EPICODE " + stringa;
  }
}
console.log(epify("oggi vado al mare"));
...
console.log(reverseString("ciao mi chiamo giovanni"));
...
console.log(upperFirst("oggi vado al mare!"));
/* ESERCIZIO 9
...
console.log(cutString("ciao mi chiamo Giovanni"));
